...
pub fn config_page_html(
    ...
    html_template
        ...
        .replace(
            "{allow_dht_search_sharing_checked}",
        ...
        .replace(
            ...
            &config.rss_search_weight_percent.to_string(),
        )
        .replace(
            "{p2p_search_weight_percent}",
            &(100u8.saturating_sub(config.rss_search_weight_percent)).to_string(),
        )
        .replace(
            "{contribute_own_searches_checked}",
        ...
        .replace(
            "{search_terms_ttl_days}",
            &config.search_terms_ttl_days.to_string(),
        )
        .replace(
