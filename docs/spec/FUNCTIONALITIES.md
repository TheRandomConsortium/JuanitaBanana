...
| **P2P Gossip Protocol** | 📋 Planned | Decentralized sharing of anonymized searches to use real user data as noise across peers. Detailed in [SEARCH_GOSSIP_DHT.md](file:///home/mreugenej7/git/juanita-banana/docs/spec/SEARCH_GOSSIP_DHT.md). Includes E2EE direct 1-hop exchanges, RSS vs P2P weight sliders, own-search contribution toggles, search term TTL, prohibited keyword regex filtering, and the `juanita://search-explorer` crown jewel. |
